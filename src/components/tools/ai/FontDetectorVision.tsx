  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500 px-4 sm:px-0 pb-20 mt-4">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => {setFile(null); setImgUrl(null); setMatches(null)}} className="text-sm font-medium text-muted-foreground hover:text-foreground flex items-center gap-2">
