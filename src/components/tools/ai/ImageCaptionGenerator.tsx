...
["<caption 1>", "<caption 2>", "<caption 3>"]`
  ...
  if (!file || !imgUrl) {
    return (
       <ToolUploadLayout title="Image Caption Generator" description="Upload any image and let Claude write engaging, platform-perfect captions in seconds." icon={MessageSquare}>
         <AIProviderHint />
